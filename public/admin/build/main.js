...
/***/ function(module, exports, __webpack_require__) {
	...
	myApp.config(['NgAdminConfigurationProvider', function (nga) {
	    ...
	    admin.dashboard(__webpack_require__(163)(nga, admin));
	    admin.header(__webpack_require__(165));
	    admin.menu(__webpack_require__(166)(nga, admin));
	...
	function graph(Restangular) {
		...
		return {
			...
			controller: function controller($scope, VisDataSet) {
				...
				Restangular.one('dashboard/chart/salesreport_2').get().then(function successCallback(response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardHtml = __webpack_require__(164);
